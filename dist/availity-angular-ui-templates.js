...
(function() {
'use strict';
angular.module("availity.ui.templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("ui/breadcrumbs/breadcrumbs-tpl.html","<ul class=\"breadcrumb\"><li data-ng-repeat=\"breadcrumb in breadcrumbs\" data-ng-class=\"{ active: $last }\"><a ui-sref=\"{{breadcrumb.state}}\" data-ng-if=\"!$last\" data-ng-bind=\"breadcrumb.displayName\"></a> <span data-ng-if=\"$last\" data-ng-bind=\"breadcrumb.displayName\"></span></li></ul>");
