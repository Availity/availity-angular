...
$templateCache.put("ui/tabs/tab-tpl.html","<li role=\"presentation\" data-ng-class=\"{ active: active, disabled: disabled }\"><a href=\"\" role=\"tab\" data-ng-click=\"select()\" data-ng-bind-html=\"heading\"></a></li>");
$templateCache.put("ui/tabs/tabs-tpl.html","<div><ul class=\"nav nav-{{tabType || \'tabs\'}}\" data-ng-class=\"{ \'nav-stacked\': vertical, \'nav-justified\': justified }\" data-ng-transclude></ul><div class=\"tab-content\" data-ng-class=\"{ \'tab-bump\' : padContent }\"><div data-ng-repeat=\"tab in tabs\" data-av-tab-pane=\"tab\" data-ng-class=\"{ active: tab.active }\" role=\"tabpanel\"></div></div></div>");}]);
