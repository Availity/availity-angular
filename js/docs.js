...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _jquery=__webpack_require__(305);var _jquery2=_interopRequireDefault(_jquery);var _module=__webpack_require__(400);var _module2=_interopRequireDefault(_module);__webpack_require__(404);__webpack_require__(399);__webpack_require__(405);__webpack_require__(406);__webpack_require__(407);__webpack_require__(408);__webpack_require__(411);__webpack_require__(415);__webpack_require__(421);__webpack_require__(422);__webpack_require__(423);__webpack_require__(424);__webpack_require__(425);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_module2.default.controller('PageController',function(){// no op
	});function toggleButtons(){// Add View Code toggle button for each example
	(0,_jquery2.default)('.docs-example').each(function(){var btn='\n      <div>\n        <hr class="divider-lg" />\n        <div class="btn-toolbar">\n          <button class="btn btn-ghost btn-sm" data-toggle="code">View Code<i class="icon icon-code"></i></button>\n        </div>\n      </div>';if((0,_jquery2.default)(this).next().is('[class*="language-"]')){(0,_jquery2.default)(this).append((0,_jquery2.default)(btn));}});(0,_jquery2.default)('[data-toggle="code"]').click(function(e){e.preventDefault();var target=(0,_jquery2.default)(this).parents('.docs-example').next('[class*="language-"]');if(target.is(':visible')){target.velocity('slideUp',{duration:200});}else{target.velocity('fadeIn',{duration:300,display:'block'});}});}(0,_jquery2.default)(document).ready(function(){toggleButtons();});_module2.default.run(function($httpBackend){$httpBackend.whenRoute('POST','/api/v1/log-messages').respond({});});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _angular=__webpack_require__(303);var _angular2=_interopRequireDefault(_angular);__webpack_require__(401);__webpack_require__(403);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default=_angular2.default.module('availity.demo',['availity','availity.ui','availity.config','ngAnimate','ngSanitize','ui.router','ngMockE2E']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoAnalyticsController',function($scope){$scope.analytics={createError:function createError(){throw new Error('Oh snap!');}};});_demo2.default.config(function(avPiwikAnalyticsProvider){avPiwikAnalyticsProvider.enable(true);});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);var _=__webpack_require__(310);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoUtilsController',function($scope){$scope.vm={print:function print(){(0,_.print)();}};});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);__webpack_require__(409);var _permissions=__webpack_require__(410);var _permissions2=_interopRequireDefault(_permissions);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoAuthenticationController',function($scope,demoAuthenticationService){$scope.vm=demoAuthenticationService;});_demo2.default.run(function($httpBackend){$httpBackend.whenRoute('GET',/\/api\/internal\/v1\/axi-user-permissions\?cacheBust=.*&permissionId=(7100|8100|9100)/).respond(_permissions2.default);});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);__webpack_require__(332);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}_demo2.default.factory('demoAuthenticationService',function(avUserAuthorizations){var DemoAuthenticationService=function(){function DemoAuthenticationService(){_classCallCheck(this,DemoAuthenticationService);this.permissionId='7100';this.isAuthorized=false;this.init();}_createClass(DemoAuthenticationService,[{key:'init',value:function init(){var self=this;avUserAuthorizations.isAuthorized(this.permissionId).then(function(isAuthorized){self.isAuthorized=isAuthorized;});}}]);return DemoAuthenticationService;}();return new DemoAuthenticationService();});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';__webpack_require__(412);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);__webpack_require__(413);var _validationRules=__webpack_require__(414);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoValidationController',function($scope,demoValidationService){$scope.vm=demoValidationService;});_demo2.default.config(function(avValProvider){avValProvider.addRules({defaultRules:_validationRules.defaultRules,stateRules:_validationRules.stateRules});});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _lodash=__webpack_require__(333);var _=_interopRequireWildcard(_lodash);var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj;}else{var newObj={};if(obj!=null){for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key))newObj[key]=obj[key];}}newObj.default=obj;return newObj;}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}_demo2.default.factory('demoValidationService',function(AV_VAL){var DemoValidationService=function(){function DemoValidationService(){_classCallCheck(this,DemoValidationService);this.firstName='Robert';this.lastName=null;this.phone=null;this.email=null;this.ssn=null;this.icd9=null;this.npi=null;this.date=new Date();this.rule='defaultRules';this.selectedSate=null;this.states=[{id:'AL',name:'Alabama'},{id:'CA',name:'California'},{id:'NM',name:'New Mexico'},{id:'TX',name:'Texas'},{id:'WY',name:'Wyoming'}];// keep a copy of the original state
	this.originalState=_.assign({},this);}_createClass(DemoValidationService,[{key:'onChangeRules',value:function onChangeRules(){this.rule=this.rule==='stateRules'?'defaultRules':'stateRules';}},{key:'reset',value:function reset($scope){_.assign(this,this.originalState);$scope.$broadcast(AV_VAL.EVENTS.RESET);}}]);return DemoValidationService;}();return new DemoValidationService();});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _=__webpack_require__(333);var defaultRules={ssn:{required:{message:'SSN is required.'},pattern:{value:/\d{3}-?\d{2}-?\d{4}/,message:'SSN must be between in a format like ***-**-****.'}},lastName:{required:{message:'Last name is required.'},size:{min:2,max:10,message:'Last name must be between 2 and 10 characters.'}},firstName:{required:{message:'First name is required.'},size:{min:2,max:20,message:'First name must be between 2 and 20 characters.'}},date:{dateFormat:{format:'MM/DD/YYYY',message:'Format needs to be MM/DD/YYYY'},dateRange:{start:{value:'-10',units:'days'},end:{value:'10',units:'days'},format:'MM/DD/YYYY',message:'Date is not within 10 days from today'}},icd9:{pattern:{value:/(V\d{2}(\.\d{1,2})?|\d{3}(\.\d{1,2})?|E\d{3}(\.\d)?)/,message:'ICD-9 code is invalid'}},npi:{npi:{message:'NPI is invalid.'}},checked:{required:{message:'You must agree to terms.'}},taxId:{pattern:{value:/^\d{3}-?\d{2}-?\d{4}|[0-9]{2}-[0-9]{7}|9\d{2}-[7,8]\d-\d{4}|p?-?\d{8}$/,message:'Tax ID needs to be a valid SSN, EIN, ITIN, ATIN, PTIN'}},phone:{required:{message:'Phone number is required'},phone:{message:'Phone number is invalid'}},email:{required:{message:'Email is required'},email:{message:'Email is invalid'}},someRequiredField:{required:{message:'This field is required, and the validation error shows even with a clean model.'}}};var stateRules=_.extend({},defaultRules,{'lastName':null,'firstName':{'required':null,'size':{'min':2,'max':20,'message':'First name must be between 2 and 20 characters.'}},'states':{'required':{'message':'State selection is required.'}},'checked':{'required':{'message':'You just agree to terms.'}},'date':{'required':{'message':'Date is required.'},'dateFormat':{'format':'MM/DD/YYYY','message':'Format needs to be MM/DD/YYYY'},'dateRange':{'start':{'value':'05022015'},'end':{'value':'05152015'},'format':'MMDDYYYY','message':'Date Range is invalid.'}}});exports.defaultRules=defaultRules;exports.stateRules=stateRules;
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);__webpack_require__(416);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoModalController',function($scope,demoModalService){demoModalService.init($scope);$scope.vm=demoModalService;});_demo2.default.config(function($stateProvider){$stateProvider.state('one',{url:'/'}).state('two',{url:'/two'}).state('three',{url:'/three'});});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);var _modalTemplate=__webpack_require__(417);var _modalTemplate2=_interopRequireDefault(_modalTemplate);var _modalLgTemplate=__webpack_require__(418);var _modalLgTemplate2=_interopRequireDefault(_modalLgTemplate);var _modalSmTemplate=__webpack_require__(419);var _modalSmTemplate2=_interopRequireDefault(_modalSmTemplate);var _modalRouteTemplate=__webpack_require__(420);var _modalRouteTemplate2=_interopRequireDefault(_modalRouteTemplate);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}_demo2.default.factory('demoModalService',function(AvModal,$log,$state,avModalManager,$rootScope){var AvDemoService=function(){function AvDemoService(){_classCallCheck(this,AvDemoService);this.listeners();}_createClass(AvDemoService,[{key:'init',value:function init($scope){this.$scope=$scope;}},{key:'listeners',value:function listeners(){$rootScope.$on('$stateChangeSuccess',function(event,toState){if(toState.name==='three'){avModalManager.closeAll();}});}},{key:'navigate',value:function navigate(){var state='two';if($state.includes('two')){state='three';}$state.go(state);}},{key:'modalOpen',value:function modalOpen(){AvModal.create({show:true,scope:this.$scope,templateUrl:_modalTemplate2.default});}},{key:'modalOpenLarge',value:function modalOpenLarge(){AvModal.create({show:true,scope:this.$scope,templateUrl:_modalLgTemplate2.default});}},{key:'modalOpenSmall',value:function modalOpenSmall(){var modalSmall=new AvModal({scope:this.$scope,templateUrl:_modalSmTemplate2.default});modalSmall.show().then(function(){$log.info('modal shown');});}},{key:'routeChange',value:function routeChange(){AvModal.create({show:true,scope:this.$scope,templateUrl:_modalRouteTemplate2.default});}}]);return AvDemoService;}();return new AvDemoService();});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoDatepickerController',function($scope){$scope.demo={date1:new Date(),date2:null,date3:null};});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoPopoverController',function($scope){$scope.showOnLoad=true;});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoTooltipController',function($scope){$scope.showOnLoad=true;});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoHidePermissionController',function(){});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);__webpack_require__(426);var _photos=__webpack_require__(430);var _photos2=_interopRequireDefault(_photos);var _photos3=__webpack_require__(431);var _photos4=_interopRequireDefault(_photos3);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}_demo2.default.controller('DemoDropdownController',function($scope,demoDropdownService){$scope.vm=demoDropdownService;});_demo2.default.run(function($httpBackend){$httpBackend.whenRoute('GET',/\/api\/v1\/photos\?offset=.*&q=a.*/).respond(_photos2.default);$httpBackend.whenRoute('GET',/\/api\/v1\/photos\?offset=.*&q=.*/).respond(_photos4.default);});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);__webpack_require__(366);var _states=__webpack_require__(427);var _states2=_interopRequireDefault(_states);var _pokemon=__webpack_require__(428);var _pokemon2=_interopRequireDefault(_pokemon);__webpack_require__(429);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}_demo2.default.factory('demoDropdownService',function($log,demoDropdownResource){var DemoDropdownService=function(){function DemoDropdownService(){_classCallCheck(this,DemoDropdownService);// SIMPLE DOM EXAMPLE
	this.selectedNumber=null;// ARRAY EXAMPLE
	this.pokemon=_pokemon2.default;this.selectedPoke=null;// ARRAY OF OBJECTS EXAMPLE
	this.states=_states2.default;this.selectedState1=null;this.selectedState2=null;this.selectedState3=null;this.selectedStates=[{id:'WY',name:'Wyoming'},{id:'NM',name:'New Mexico'}];}_createClass(DemoDropdownService,[{key:'removeState',value:function removeState(){if(this.states.length>1){var removed=this.states.pop();$log.info('State '+JSON.stringify(removed)+' was removed');}}},{key:'setState1',value:function setState1(){this.selectedState1=this.states[this.states.length-1];}},{key:'setState2',value:function setState2(){this.selectedState2=this.states[this.states.length-1];}},{key:'setState3',value:function setState3(){this.selectedState3=this.states[this.states.length-1];}},{key:'setMultiple',value:function setMultiple(){this.selectedStates=[{id:'AR',name:'Arkansas'},{id:'NM',name:'New Mexico'}];}},{key:'resetPoke',value:function resetPoke(){this.selectedPoke=null;}},{key:'isPokeDisabled',value:function isPokeDisabled(){return this.selectedPoke===null;}},{key:'resetNumber',value:function resetNumber(){this.selectedNumber=null;}},{key:'isNumberDisabled',value:function isNumberDisabled(){return this.selectedNumber===null;}},{key:'resetState1',value:function resetState1(){this.selectedState1=null;}},{key:'resetState2',value:function resetState2(){this.selectedState2=null;}},{key:'resetState3',value:function resetState3(){this.selectedState3=null;}},{key:'resetMultiple',value:function resetMultiple(){this.selectedStates=null;}},{key:'onChange',value:function onChange(selected){if(selected){$log.info('Selected value is '+JSON.stringify(selected));}}},{key:'getOptions',value:function getOptions(){return{allowClear:true,placeholder:'Find a photo',minimumInputLength:3,query:demoDropdownResource};}}]);return DemoDropdownService;}();return new DemoDropdownService();});
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _demo=__webpack_require__(400);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}_demo2.default.factory('demoDropdownResource',function(AvSelectResource){var DemoPhotosResource=function(_AvSelectResource){_inherits(DemoPhotosResource,_AvSelectResource);function DemoPhotosResource(){_classCallCheck(this,DemoPhotosResource);return _possibleConstructorReturn(this,Object.getPrototypeOf(DemoPhotosResource).call(this,{name:'photos'}));}_createClass(DemoPhotosResource,[{key:'getResults',value:function getResults(response){return response.photos;}},{key:'mapResult',value:function mapResult(item){return{id:item.id,text:item.title};}}]);return DemoPhotosResource;}(AvSelectResource);return new DemoPhotosResource();});
