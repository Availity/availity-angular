...
fdescribe('avUserAuthorizations', function() {
  ...
  var fixtures = {
    urls: {
      "get452_999": "/api/internal/v1/axi-user-permissions?permissionId=452&permissionId=999",
      "get452": "/api/internal/v1/axi-user-permissions?permissionId=452",
      "get999": "/api/internal/v1/axi-user-permissions?permissionId=999"
    },
    valid: {
      "axiUserPermissions": [{
        "id": "452",
  ...
  describe('getPermissions()', function() {
    it('should get have 452 but not 999', function() {
      availity.mock.$httpBackend.expectGET(fixtures.urls.get452_999).respond(200, fixtures.valid);
    ...
    it('should include region if set', function() {
      ...
      availity.mock.$httpBackend.expectGET(fixtures.urls.get452_999 + '&region=ALL').respond(200, fixtures.valid);
      avUserAuthorizations.getPermissions(['452', '999']).then(function(permissions) {
        expect(_.isArray(permissions)).toBe(false);
        expect(_.size(permissions)).toBe(2);
        expectPermission452(permissions['452']);
  ...
  describe('getPermission()', function() {
    it('should get permission 452', function() {
      availity.mock.$httpBackend.expectGET(fixtures.urls.get452).respond(200, fixtures.valid);
    ...
    it('should not have permission 999', function() {
      availity.mock.$httpBackend.expectGET(fixtures.urls.get999).respond(200, fixtures.empty);
  ...
  describe('getPayers()', function() {
    ...
    it('should no payers for 452 and 1001', function() {
      availity.mock.$httpBackend.expectGET(fixtures.urls.get452).respond(200, fixtures.empty);
