(function(root) {
  ...
  var AvUserAuthorizationsFactory = function($q, avUsersResource, avUserPermissionsResource) {
    ...
    var AvUserAuthorizations = function() {
      ...
      this.invalidateUser = true;  // Force reload of permission on server
    };
    ...
    proto.toggleInvalidate = _.once(function() {
      !!this.invalidateUser;
    });
    ...
    proto.getPermissions = function(permissionIds) {
      ...
      return avUserPermissionsResource
        .getPermissions(permissionIds, this.region, this.invalidateUser)
        .then(function(_permissions) {
          self.toggleInvalidate();
