...
describe('avValPattern', function () {
  ...
  it('should NOT be a valid ICD9 code', function(){
    ...
    expect(patternTest.validate('', icd9Rule)).toBe(false);
  ...
  it('should NOT be a valid TaxID', function(){
    ...
    expect(patternTest.validate('', taxidRule)).toBe(false);
    ...
    expect(patternTest.validate('', taxidRuleArray)).toBe(false);
  });
