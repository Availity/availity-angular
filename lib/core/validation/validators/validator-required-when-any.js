...
(function(root) {
  ...
  availity.core.factory('avValRequiredWhenAny', function(avValUtils, avValRequiredWhen) {
            ...
            for (var index in check) {
              if (index) {
                ...
                if (!valid) {
                  ...
                  valid = avValRequiredWhen.validate(index, requiredWhenRule);
                }
              }
            }
          });
