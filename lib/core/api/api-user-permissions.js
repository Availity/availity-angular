(function (root) {
  ...
  var UserPermissionsFactory = function (AvApiResource) {
    ...
    angular.extend(AvUserPermissionsResource.prototype, AvApiResource.prototype, {
      ...
      getPermissions: function (permissionId, region, invalidateUser) {
        return this.all({params: {permissionId: permissionId, region: region, invalidateUser: invalidateUser, limit: 1000, offset: 0}});
      }
