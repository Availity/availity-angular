(function(root) {
  ...
  /**
   * CacheItem is wrapper around value with all outstanding promises
   * @constructor
   */
  function AvCacheItem() {
    this.value = null;
    this.loading = null;
    this.error = null;
    this.promises = [];
  ...
  AvCacheItem.prototype.invalidate = function() {
    this.value = null;
    this.loading = null;
    this.error = null;
    this.resolveAll();
  ...
  AvCacheItem.prototype.onSuccess = function(value) {
    this.value = value;
    this.loading = false;
    this.error = false;
    this.resolveAll();
  ...
  AvCacheItem.prototype.onError = function() {
    this.value = null;
    this.loading = false;
    this.error = true;
    this.resolveAll();
  ...
  AvCacheItem.prototype.shouldLoad = function() {
  ...
  AvCacheItem.prototype.promise = function() {
  ...
  AvCacheItem.prototype.resolve = function(deferred) {
    if(this.error === true) {
  ...
  AvCacheItem.prototype.resolveAll = function() {
    var self = this;
  ...
  AvCache.prototype.get = function(key, valueLoader) {
    var self = this;
    var cacheItem = self.getCacheItem(key);
   ...
   * @private
   */
  AvCache.prototype.getCacheItem = function(key) {
    key = normalizeKey(key);
    var cacheItem = this.cacheItems[key];
    if(!cacheItem) {
      cacheItem = new AvCacheItem();
