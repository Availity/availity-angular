(function(root) {
  ...
  availity.core.provider('avIdle', function() {
    ...
    this.$get = function(AV_IDLE, $document, $rootScope, $timeout, avThrottle) {
      ...
      proto.onEnabled = function() {
        $document.find('body').on(AV_IDLE.EVENTS.HUMAN, this.onEvent.call(this));
        $rootScope.$on(AV_IDLE.EVENTS.MACHINE, this.onEvent.call(this));
      };
