/*global availity, module, beforeEach, spyOn, inject, it, spyOn, it, expect, describe, jasmine */
describe('avIdleProvider', function() {
  ...
  describe('avIdle', function() {
    ...
    it('should broadcast idle event when no activity is detected', function() {
      ...
      $timeout.flush(1);
      expect($rootScope.$broadcast).toHaveBeenCalledWith(AV_IDLE.EVENTS.IDLE_ACTIVE, jasmine.any(Number));
