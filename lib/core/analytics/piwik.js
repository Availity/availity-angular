...
module.provider('avPiwikAnalytics', () => {
  ...
  this._setCustomVariable = (index, valueName, value, scope) => {
  ...
  this.setPageVariables = (index, name, value) => {
    this._setCustomVariable(index, name, value, 'page');
  };

  this.$get = (avAnalyticsUtils, avUsersResource, AV_ANALYTICS, $injector, $log, $q, $document, $location) => {
