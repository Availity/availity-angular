/* global describe, afterEach, beforeEach, expect, it, inject, spyOn */
import $ from 'jquery';
...
describe('avPiwikAnalytics', () => {
  ...
  beforeEach(angular.mock.module( (avPiwikAnalyticsProvider) => { avPiwikAnalyticsProvider.setSiteID(1) }));
