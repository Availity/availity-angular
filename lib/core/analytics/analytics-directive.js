(function(root) {
  ...
  availity.core.controller('AvAnalyticsOnController', function(avAnalyticsUtils, $element, $attrs, avAnalyticsServices) {
    ...
    this.onEvent = function(event) {
      ...
      var promise = avAnalyticsServices.send(properties);
