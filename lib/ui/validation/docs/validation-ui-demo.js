(function(root) {
  ...
  availity.demo.config(function(avAnalyticsProvider, avValProvider, avErrorServicesProvider, avPiwikAnalyticsServiceProvider) {
    var visitVariables = [
      [1,'testVName', '23'],
      [2,'testVName', '23'],
      [3,'testVName', '23']
    ];
    avErrorServicesProvider.appName = 'Availity Demo';

    avPiwikAnalyticsServiceProvider.setSiteID(12);
    avPiwikAnalyticsServiceProvider.setVisitVariables(visitVariables);
