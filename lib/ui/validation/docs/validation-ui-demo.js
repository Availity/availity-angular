(function(root) {
  ...
  availity.demo.controller('ValidationController', function($scope, $window) {
  ...
  availity.demo.config(function(avValProvider,avAnalyticsServicesProvider, avErrorServicesProvider) {
    avAnalyticsServicesProvider.virtualPageTracking(true);
