  ...
  availity.ui.directive('avValField', function($log, $timeout, avVal, avValAdapter, AV_VAL) {
    return {
      ...
      link: function(scope, element, attrs, controllers) {
        ...
        var avValDebounce = parseInt(scope.avValDebounce || avValForm.avValDebounceDefault || AV_VAL.DEBOUNCE, 10);
        ...
        var avValOn = scope.avValOn || avValForm.avValOnDefault || null;
        var blurOnly = avValOn === 'blurOnly';

        if(debounceAllowed && !blurOnly) {
