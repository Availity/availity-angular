...
describe('avValField', function() {
  ...
  beforeEach(function() {
    ...
    '<form name="myForm" data-av-val-form="default">' +
      ...
      '</div>' +
      '<input data-ng-model="demo.invalidAllowed" name="invalidAllowed" type="text" data-av-val-field="lastName" data-av-val-invalid-model-data="true"/>' +
  ...
  describe('events', function() {
    ...
    it('should have not an error message in last name help block', function () {
      availity.mock.$scope.myForm.lastName.$setViewValue('1');
      availity.mock.$scope.$digest();

      var message = $('#lastNameErrorMessage');
    ...
    it('should have not have .has-error class on form-group', function () {
      availity.mock.$scope.myForm.lastName.$setViewValue('1');
      availity.mock.$scope.$digest();
