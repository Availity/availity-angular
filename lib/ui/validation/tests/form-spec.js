...
describe('avForm', function() {
  ...
  it('should not immediately show error for firstName with false av-val-show', function() {
    var template = '' +
    '<form name="myForm" ng-submit="submit()" data-av-val-form="demo.rules" data-av-val-show="false">' +
  ...
  it('should immediately show error for firstName with true av-val-show', function() {
    var template = '' +
  ...
  it('should immediately show error for firstName based on variable value', function() {
    var template = '' +
    '<form name="myForm" ng-submit="submit()" data-av-val-form="demo.rules" data-av-val-show="demo.variable">' +
      '<div id="showOnLoadFormGroup" class="form-group">' +
        '<input data-ng-model="demo.showOnLoad" name="showOnLoad" type="text" data-av-val-field="lastName"/>' +
        '<p data-av-val-container></p>' +
      '</div>' +
    ...
    availity.mock.$scope.demo.variable = true;
