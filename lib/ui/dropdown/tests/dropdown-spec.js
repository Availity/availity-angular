/* global availity, xdescribe, spyOn, inject, describe, it, beforeEach, expect, module*/

/* global availity, xdescribe, spyOn, inject, describe, it, beforeEach, expect, module*/

xdescribe('avDropdown', function() {
  let $el;
  let avCodesResource;
  let $httpBackend;
  ...
  const ajaxResp = {'totalCount': 560, 'count': 50, 'offset': 0, 'limit': 50, 'codes': [{'code': '1', 'value': 'Test 1'}, {'code': '2', 'value': 'Test 2'}, {'code': '3', 'value': 'Test 3'}]};
  const exampleParams = {'q': 'charizard', 'list': 'someList', 'page': 1};
  ...
  describe('query', function() {
    ...
    it('should update model', function() {
      ...
      const validValue = ajaxResp.codes[0];
      validValue.id = '1';

      const event = new jQuery.Event('change');
