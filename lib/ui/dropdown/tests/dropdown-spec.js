...
describe('avDropdown', function() {
  ...
  describe('remote data should work', function() {
    ...
    beforeEach(function() {
      ...
      //codes = new AvCodesResource();
      availity.mock.$scope.demo = {};
      availity.mock.$scope.demo.selected = null;

      availity.mock.$scope.myQuery = function(data) {
    ...
    it('api resource should exist', function() {
    ...
    it('resource should query results', function() {
      // expectGET to make sure this is called once.
      $httpBackend.expectGET('/api/v1/codes').respond(200, ajaxResp);

      AvCodesResource.query().success(function(data) {
        expect(data).toBeEqual(ajaxResp);
      });
