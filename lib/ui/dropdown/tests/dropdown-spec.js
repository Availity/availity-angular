...
describe('avDropdown', function() {
  ...
  describe('multiple', function() {
    ...
    it('should throw a error letting the user know they need to specify a value to use for ID', function () {
      ...
      expect($el.controller('ngModel')).toThrow(new Error('dropdown list must have a id or a alternative value to use as a id'));
