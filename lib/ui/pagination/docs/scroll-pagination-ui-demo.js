(function(root) {
  ...
  availity.demo.controller('ScrollPaginationController', function($scope, scrollPaginationDemoApi, avScrollPaginationService) {
    ...
    $scope.avScrollPaginationService = avScrollPaginationService
  });
