...
(function(root) {
  ...
  availity.ui.controller('AvDatepickerController', function($element, $attrs, AV_DATEPICKER, $scope) {
    ...
    this.viewToModel = function() {
      ...
      if(self.options.dateOnly) {
        localDate = moment(localDate).format(self.options.dateOnlyFormat);
      }
    ...
    this.init = function() {
      ...
      self.options.dateOnly = self.options.dateOnly ? self.options.dateOnly : AV_DATEPICKER.DEFAULTS.DATEONLY;
      self.options.dateOnlyFormat = self.options.dateOnlyFormat ? self.options.dateOnlyFormat : AV_DATEPICKER.DEFAULTS.DATEONLYFORMAT;
    };
