...
describe('avDatepicker', function() {
  ...
  var fixtures = {
    ...
    'date-only': '<input data-ng-model="selectedDate" name="date" type="text" data-av-datepicker data-date-only="true">',
    'date-only-formatted': '<input data-ng-model="selectedDate" name="date" type="text" data-av-datepicker data-date-only="true" data-date-only-format="\'DD/MM/YYYY\'">'
  };
  // jscs: enable
  ...
  it('should correctly write date-only values to the model', function() {
    availity.mock.$scope.selectedDate = null;
    $el = availity.mock.compileDirective(fixtures['default']);
  ...
  it('should correctly write date-only values to the model with optional formatting', function() {
    availity.mock.$scope.selectedDate = null;
  ...
  it('should correctly parse formatted date from VIEW with date only', function() {
    availity.mock.$scope.selectedDate = null;
    $el = availity.mock.compileDirective(fixtures['date-only']);
  ...
  it('should correctly parse ALTERNATE formatted date with date only', function() {
    availity.mock.$scope.selectedDate = null;
    $el = availity.mock.compileDirective(fixtures['date-only-formatted']);
