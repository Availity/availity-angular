...
describe('avDatepicker', function() {
  ...
  it('should correctly write date-only values to the model with default format', function() {
    availity.mock.$scope.selectedDate = null;
  ...
  it('should correctly write date-only values to the model with custom format', function() {
    availity.mock.$scope.selectedDate = null;
  ...
  it('should correctly ignore date-only values when null', function() {
    availity.mock.$scope.selectedDate = null;
    $el = availity.mock.compileDirective(fixtures['model-format-default']);
  ...
  it('should correctly ignore date-only values when empty', function() {
    availity.mock.$scope.selectedDate = null;
    $el = availity.mock.compileDirective(fixtures['model-format-default']);
