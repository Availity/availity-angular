  ...
  describe('accordion-group', function () {
    ...
    describe('with static panels', function () {
      ...
      it('should create accordion panels with content', function () {
        ...
        expect(findGroupLink(0).text().replace(/^\s+|\s+$/g, '')).toEqual('title 1');
        expect(findGroupBody(0).text().replace(/^\s+|\s+$/g, '')).toEqual('Content 1');
        expect(findGroupLink(1).text().replace(/^\s+|\s+$/g, '')).toEqual('title 2');
        expect(findGroupBody(1).text().replace(/^\s+|\s+$/g, '')).toEqual('Content 2');
      });
