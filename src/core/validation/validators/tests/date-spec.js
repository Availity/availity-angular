...
describe('avValDate', () => {
  ...
  it('should be a valid', () => {
    expect(avValDate.validate({value: '02/02/2015', constraint: constraint})).toBe(true);
  });

  it('should NOT be valid', () => {
    expect(avValDate.validate({value: '20/02/2015', constraint: constraint})).toBe(false);
  });

  it('custom format, should be a valid', () => {
    expect(avValDate.validate({value: '02022015', constraint: constraintWithFormat})).toBe(true);
  });

  it('custom format, should NOT be valid', () => {
    expect(avValDate.validate({value: '02/02/2015', constraint: constraintWithFormat})).toBe(false);
  });
