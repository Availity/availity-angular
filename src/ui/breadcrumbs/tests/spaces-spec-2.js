/* global beforeEach, expect, module, inject, describe, it, fit*/
...
describe('avSpacesBreadcrumb', () => {
  ...
  beforeEach( () => {
    angular.module('ui.router', 'availity', 'availity.ui', 'availity.ui.templates');
  });
  ...
  describe('avSpacesBreadcrumbs', () => {
    ...
    fit('should render breadcrumbs when space ID is in scope', () => {
